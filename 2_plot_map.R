...
c1 = resid_sp_fort %>% 
  ggplot(aes(y = lat, x = long, group = group)) + geom_polygon(aes(fill = value), size = 0.1, color = 'black') + coord_equal(ratio = 1.3)  + scale_fill_gradientn(colours = c("red", "white", "#56d300","#0f7000"), 
...
scotland_c_1 = resid_sp_fort %>% 
  dplyr::filter(details == 'Scotland') %>% 
  ggplot(aes(y = lat, x = long, group = group)) + geom_polygon(aes(fill = value), size = 0.1, color = 'black') + coord_equal(ratio = 1.5)  + scale_fill_gradientn(colours = c("red", "white", "#56d300","#0f7000"), 
                                                                                                                                                                  values=c(0, 0.20, 0.60, 0.70, 0.80, 1),
                                                                                                                                                                  name='Increase in\nResidential Movements', 
                                                                                                                                                                  labels = scales::percent(0.50*-1.5:1.5), breaks = 0.50*-1.5:1.5,
                                                                                                                                                                  limits = c(0, 1)) #+ 
...
scotland_c_2 = gro_pharm_sp_fort %>% 
  dplyr::filter(details == 'Scotland') %>% 
  ggplot(aes(y = lat, x = long, group = group)) + geom_polygon(aes(fill = value), size = 0.1, color = 'black') + coord_equal(ratio = 1.5) + scale_fill_gradientn(colours = c("#0f7000", "#56d300", "white", "red"), 
                                                                                                                                                                 values=c(0, 0.20, 0.25, 0.30, 0.75, 1),
                                                                                                                                                                 name='Reduction in\nPharmacy/Groceries\nMovements', 
                                                                                                                                                                 labels = scales::percent(0.50*-1.5:1.5), breaks = 0.50*-1.5:1.5,
                                                                                                                                                                 limits = c(-1, 0))# + 
...
save.image('continuous_plots.RData')
